    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='exam_creator', to=settings.AUTH_USER_MODEL)),
                ...
                ('questions', models.ManyToManyField(related_name='question_exams', to='exams.Question')),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
